  ...
  <div class=" col-md-12 top-filter">
   ...
   <div class="table">
        <table class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
					<th>{{trans('messages.S_NO')}}</th><th>{{trans('messages.STATE_ID')}} </th> <th>{{trans('messages.NAME_DISTRICT')}} </th><th class="text-right" style="padding-right:60px">{{trans('messages.ACTION')}}</th>
                </tr>
            </thead>
            <tbody>
            {{-- */$x=0;/* --}}
