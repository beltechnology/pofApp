...
<div class=" col-md-9 category">
    {!! Form::model($payment, [
	 ...
	 <div class="edit_school">
      ...
      <li><a href="{{ url('/schools/'.$payment->entityId.'/edit') }}"> School Profile </a></li>
      <li><a href="{{ url('/book-details/'.$payment->entityId.'/edit') }}"> Book Detail </a></li>
      <li ><a href="{{ url('/student-count/'.$payment->entityId.'/edit') }}"> No. of students from school </a></li>
      <li class="active"><a href="{{ url('/payments/'.$payment->entityId.'/edit') }}"> Payment Mode </a></li>
	   <li><a href="{{ url('/fees/'.$payment->entityId.'/edit') }}">Fees</a></li>
    </ul>
  </div>
</nav>
