        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($team as $item)
                ...
                <tr>
					...
					<td style="padding-left:27px">@foreach($employees as $employee) {{ $employee->name }} @endforeach <a href="{{ url('/teammember/'. $item->teamId. '/') }}" class="btn  btn-xs" title="View Team"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a></td>
